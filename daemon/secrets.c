...
{
	lnchn->secrets = tal(lnchn, struct LNchannel_secrets);
...
{
	const struct LNchannel_secrets *ps = lnchn->secrets;
...
{
	struct LNchannel_secrets *ps = tal(lnchn, struct LNchannel_secrets);
